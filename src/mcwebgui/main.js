...
MCWebGUI.Error = function (context, message) {
    console.error("%cMCWebGUI%c" + context, "padding: 4px; border-radius: 4px; background-color: white; color: black; margin-right: 4px;", "padding: 4px; border-radius: 4px; background-color: firebrick; color: black;", message);
};
MCWebGUI.Warn = function (context, message) {
    console.warn("%cMCWebGUI%c" + context, "padding: 4px; border-radius: 4px; background-color: white; color: black; margin-right: 4px;", "padding: 4px; border-radius: 4px; background-color: orange; color: black;", message);
};

if (document.title == "") {
    document.title = "MCWebGUI Document";
    MCWebGUI.Warn("Error Handling", "No \"title\" element found, using default of \"" + document.title + "\"");
};
